...
%recorre la lista de nombres del archivo de posicion inicial, u nsigned
...
%recorre la lista de nombres del archivo de posicion final
...
%asocia nodo al nombre de los nodos
...
for I=1:size(NodoP0,1)
   ...
   if NodoP0(I)<NodoQ0(I)
      ...
      if (isempty(ind))
         ...
         Long = [Long; Long0(I)];
         Zz=ImpedanciaLinea(Al(7,4), Al(7,7), LA111);
         z=[z Long0(I)/1000*Zz(2,2)];
...
zMag = abs(z_suma);
Imag=1.0 ./zMag;
Imag=min(100*ones(size(Imag)),Imag);
