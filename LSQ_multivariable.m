...
v=500*exp(-t./(0.01))+300.*cos(w.*t)+5.*cos(3*w.*t)+3.*cos(5*w.*t)
...
x=A_pinv*S %Vector de valores desconocidos
...
k21=sqrt((x(2))^2 + (x(3))^2) % Magnitud del fasor
tetha1=acos(x(2)/k21)         % Fase del fasor
