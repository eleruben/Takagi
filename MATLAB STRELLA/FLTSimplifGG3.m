...
load GG3A_2.mat;
% Lee matrices de impedancia nodal calculadas
%    Zsec
%    ZABC
%    nodos
%    Tramos
...
nTramos = Tramos;
nNodos = nTramos+1;
% Lee datos de corriente medida en la subestacion
%    'VA','VB','VC','IA','IB','IC','V0','V1','V2','I0','I1','I2'
%    Cada vector contiene 15 fasores correspondientes a 15 ciclos
%  Tambien lee la fase donde ocurrio la falla 'FaseFallada'
load FasoresGG3A.mat
