...
class Aplicacion ( wx.Frame ):
    ...
    def crear_panel_main(self):
        ...
        self.m_comboBox1 = wx.ComboBox( self.m_panel3, wx.ID_ANY, u"MODELO_MATLAB", wx.DefaultPosition, wx.DefaultSize, self.m_comboBox1Choices, 0 )
        ...
        self.m_comboBox1.SetValue('MODELO_MATLAB')
        ...
        nombres=[('Conexion',60, False, wxgrid.GridCellStringRenderer()),
            ('R0 (Ohm/Km)',80, False, wxgrid.GridCellStringRenderer()),
            ('R1 (Ohm/Km)',80, False, wxgrid.GridCellStringRenderer()),
            ('X0 (Ohm/Km)',80, False, wxgrid.GridCellStringRenderer()),
            ('X1 (Ohm/Km)',80, False, wxgrid.GridCellStringRenderer()),
            ('Distancia (Km)',100, False, wxgrid.GridCellStringRenderer())]
        ...
        nombres=[('Nombre de carga',120, False, wxgrid.GridCellStringRenderer()),
            ('P (W)',60, False, wxgrid.GridCellStringRenderer()),
            ('Q (VAr)',60, False, wxgrid.GridCellStringRenderer())]
        ...
        self.m_textCtrl4.SetToolTipString('Nombre del nodo')
        ...
        self.m_staticText12.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText12, pos=(0,0))
        
        self.m_staticText13 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"R0 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText13.Wrap( -1 )
        self.m_staticText13.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText13, pos=(0,1))
        
        self.m_staticText14 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"R1 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText14.Wrap( -1 )
        self.m_staticText14.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText14, pos=(0,2))
        
        
        self.m_staticText15 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"X0 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText15.Wrap( -1 )
        self.m_staticText15.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText15, pos=(0,3))
        
        self.m_staticText16 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"X1 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText16.Wrap( -1 )
        self.m_staticText16.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText16, pos=(0,4))
        
        self.m_staticText17 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"Distancia (Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText17.Wrap( -1 )
        self.m_staticText17.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        ...
        self.m_textCtrl1R0.SetToolTipString('Resistencia de secuencia 0')
        ...
        self.m_textCtrl1R1.SetToolTipString('Resistencia de secuencia 1')
        ...
        self.m_textCtrl1X0.SetToolTipString('Reactancia de secuencia 0')
        ...
        self.m_textCtrl1X1.SetToolTipString('Reactancia de secuencia 1')
        ...
        self.m_textCtrl1Dis.SetToolTipString('Distancia de la conexion')
        ...
        self.m_button12.SetToolTipString('Eliminar conexion')
        self.Bind(wx.EVT_BUTTON, self.EliminarConexion, self.m_button12)
        self.m_button12.Enable(False)
        ...
        self.m_staticText18.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText18, pos=(2,0))
        
        self.m_staticText19 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"R0 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText19.Wrap( -1 )
        self.m_staticText19.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText19, pos=(2,1))
        
        self.m_staticText20 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"R1 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText20.Wrap( -1 )
        self.m_staticText20.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText20, pos=(2,2))
        
        
        self.m_staticText21 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"X0 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText21.Wrap( -1 )
        self.m_staticText21.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText21, pos=(2,3))
        
        self.m_staticText22 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"X1 (Ohm/Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText22.Wrap( -1 )
        self.m_staticText22.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        grid.Add(self.m_staticText22, pos=(2,4))
        
        self.m_staticText23 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"Distancia (Km)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText23.Wrap( -1 )
        self.m_staticText23.SetFont( wx.Font( 8, 74, 90, 90, False, "Arial" ) )
        ...
        self.m_textCtrl2R0.SetToolTipString('Resistencia de secuencia 0')
        ...
        self.m_textCtrl2R1.SetToolTipString('Resistencia de secuencia 1')
        ...
        self.m_textCtrl2X0.SetToolTipString('Reactancia de secuencia 0')
        ...
        self.m_textCtrl2X1.SetToolTipString('Reactancia de secuencia 1')
        ...
        self.m_textCtrl2Dis.SetToolTipString('Distancia de la conexion')
        ...
        self.m_staticText19 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"P (W)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText19.Wrap( -1 )
        self.m_staticText19.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        gridCarga.Add(self.m_staticText19, pos=(0,1))
        
        self.m_staticText20 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"Q (VAr)", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticText20.Wrap( -1 )
        ...
        bSizerInsertarInd =wx.BoxSizer( wx.VERTICAL )
        bSizerEliminarInd =wx.BoxSizer( wx.VERTICAL )
        bSizerSeleccion =wx.BoxSizer( wx.VERTICAL )
        
        gridIndicadores = wx.GridBagSizer(hgap=5, vgap=2)
        gridEliminar = wx.GridBagSizer(hgap=2, vgap=2)
        gridSeleccionar = wx.GridBagSizer(hgap=2, vgap=2)
        
        self.m_radioBtn3 = wx.RadioButton( self.m_panel7, -1, " Insertar o editar indicador ", style = wx.RB_GROUP )
        bSizerInsertarInd.Add( self.m_radioBtn3, 0, wx.ALL, 5 )
        panelIndicadoresSizer.Add( bSizerInsertarInd, 0, wx.ALL, 5 )
        
        
        
        self.m_staticTextIndN1 = wx.StaticText( self.m_panel7, wx.ID_ANY, u"Nodo 1", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextIndN1.Wrap( -1 )
        self.m_staticTextIndN1.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        gridIndicadores.Add(self.m_staticTextIndN1, pos=(0,0))
        
        self.m_staticTextIndN2 = wx.StaticText( self.m_panel7, wx.ID_ANY, u"Nodo 2", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextIndN2.Wrap( -1 )
        self.m_staticTextIndN2.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        gridIndicadores.Add(self.m_staticTextIndN2, pos=(0,1))
        
        self.m_staticTextIndNom = wx.StaticText( self.m_panel7, wx.ID_ANY, u"Nombre", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextIndNom.Wrap( -1 )
        self.m_staticTextIndNom.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        gridIndicadores.Add(self.m_staticTextIndNom, pos=(0,2))
        
        self.m_staticTextIndDis = wx.StaticText( self.m_panel7, wx.ID_ANY, u"Distancia", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextIndDis.Wrap( -1 )
        self.m_staticTextIndDis.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        gridIndicadores.Add(self.m_staticTextIndDis, pos=(0,3))
        
        
        self.m_comboBox6Choices = []
        self.m_comboBox6Choices = self.objetoBaseDatos.consultaNodos1Indicadores()
        self.m_comboBox6 = wx.ComboBox( self.m_panel7, wx.ID_ANY, u"----", wx.DefaultPosition, size=wx.Size(70,25), choices=self.m_comboBox6Choices, style=0 )
        self.Bind(wx.EVT_COMBOBOX, self.EvtComboBoxIndNodo1, self.m_comboBox6)
        gridIndicadores.Add(self.m_comboBox6, pos=(1,0))
        
        
        
        #self.m_comboBox7Choices = self.objetoBaseDatos.tablaNodos()
        self.m_comboBox7Choices = self.objetoBaseDatos.consultaNodos1Indicadores()
        self.m_comboBox7 = wx.ComboBox( self.m_panel7, wx.ID_ANY, u"----", wx.DefaultPosition, size=wx.Size(70,25), choices=self.m_comboBox7Choices, style=0 )
        self.Bind(wx.EVT_COMBOBOX, self.EvtComboBoxIndNodo2, self.m_comboBox7)
        gridIndicadores.Add(self.m_comboBox7, pos=(1,1))
        self.m_comboBox7.Enable(False)
        
        self.m_textCtrlNuevoIndicador = wx.TextCtrl( self.m_panel7, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, size=wx.Size(80,25), style=0 )
        self.Bind(wx.EVT_TEXT, self.EvtTextNuevoIndicador, self.m_textCtrlNuevoIndicador)
        gridIndicadores.Add(self.m_textCtrlNuevoIndicador, pos=(1,2))
        self.m_textCtrlNuevoIndicador.Enable(False)
        
        
        self.m_textCtrlDistanciaIndicador = wx.TextCtrl( self.m_panel7, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, size=wx.Size(80,25), style=0 )
        self.Bind(wx.EVT_TEXT, self.EvtTextDistanciaIndicador, self.m_textCtrlDistanciaIndicador)
        gridIndicadores.Add(self.m_textCtrlDistanciaIndicador, pos=(1,3))
        self.m_textCtrlDistanciaIndicador.Enable(False)
        
        self.m_buttonInsertar = wx.Button( self.m_panel7, wx.ID_ANY, u"Insertar indicador", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_buttonInsertar.Enable(False)
        self.Bind(wx.EVT_BUTTON, self.NuevoIndicador, self.m_buttonInsertar)
        gridIndicadores.Add(self.m_buttonInsertar, pos=(1,4))
        
        panelIndicadoresSizer.Add( gridIndicadores, 0, wx.ALL, 5 )
        
        panelIndicadoresSizer.AddSpacer(15)
        
        self.m_radioBtn4 = wx.RadioButton( self.m_panel7, -1, " Eliminar indicador " )
        bSizerEliminarInd.Add( self.m_radioBtn4, 0, wx.ALL, 5 )
        
        self.m_staticTextIndElimi = wx.StaticText( self.m_panel7, wx.ID_ANY, u"Nombre indicador\t\t\t\t", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextIndElimi.Wrap( -1 )
        self.m_staticTextIndElimi.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        ...
        self.m_comboBox8.Enable(False)
        
        
        self.m_buttonEliminar = wx.Button( self.m_panel7, wx.ID_ANY, u"Eliminar indicador", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_buttonEliminar.Enable(False)
        self.Bind(wx.EVT_BUTTON, self.EliminarIndicador, self.m_buttonEliminar)
        gridEliminar.Add(self.m_buttonEliminar, pos=(1,1))
        
        bSizerEliminarInd.Add( gridEliminar, 0, wx.ALL, 5 )
        panelIndicadoresSizer.Add( bSizerEliminarInd, 0, wx.ALL, 5 )
        
        panelIndicadoresSizer.AddSpacer(15)
        
        self.m_radioBtn5 = wx.RadioButton( self.m_panel7, -1, " Seleccionar ultimo identificador activado " )
        bSizerSeleccion.Add( self.m_radioBtn5, 0, wx.ALL, 5 )
        
        self.m_staticTextIndSel = wx.StaticText( self.m_panel7, wx.ID_ANY, u"Ultimo indicador activado", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextIndSel.Wrap( -1 )
        self.m_staticTextIndSel.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        ...
        self.m_comboBox9.Enable(False)
        
        
        self.m_buttonSeleccionar = wx.Button( self.m_panel7, wx.ID_ANY, u"Seleccionar indicador", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_buttonSeleccionar.Enable(False)
        self.Bind(wx.EVT_BUTTON, self.SeleccionarIndicador, self.m_buttonSeleccionar) 
        gridSeleccionar.Add(self.m_buttonSeleccionar, pos=(1,1))
        
        
        bSizerSeleccion.Add( gridSeleccionar, 0, wx.ALL, 5 )
        panelIndicadoresSizer.Add( bSizerSeleccion, 0, wx.ALL, 5 )
        
        self.group2_ctrls = []        
        self.group2_ctrls.append((self.m_radioBtn3, self.m_comboBox6))        
        self.group2_ctrls.append((self.m_radioBtn4, self.m_comboBox8))
        self.group2_ctrls.append((self.m_radioBtn5, self.m_comboBox9))

        for radio, text in self.group2_ctrls:
            wx.EVT_RADIOBUTTON( self, radio.GetId(), self.OnGroup2Select )
        

        self.m_panel7.SetSizer( panelIndicadoresSizer )
        ...
        letrasInicioSizer.AddSpacer(6)
        self.m_staticTextTramo = wx.StaticText( self.m_panel1, wx.ID_ANY, u"Tramo en falla ", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_staticTextTramo.Wrap( -1 )
        self.m_staticTextTramo.SetFont( wx.Font( 10, 74, 90, 90, False, "Arial" ) )
        letrasInicioSizer.Add( self.m_staticTextTramo, 0, wx.ALL, 5 )
        ...
        self.m_textCtrlTramo = wx.TextCtrl( self.m_panel1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
        self.m_textCtrlTramo.Enable( False )
        cajasInicioSizer.Add( self.m_textCtrlTramo, 0, wx.ALL, 5 )
    ...
    def on_faseA_corriente(self, event):
        ...
        if self.manual:
            ...
            if self.m_checkBox4.IsChecked():
                if self.m_checkBox5.IsChecked() and not self.m_checkBox6.IsChecked():
                    self.faseA=True
                    #self.axes_corriente.set_title('Seleccione el ciclo prefalla')
                    self.dibujar_corriente()
    ...
    def on_faseB_corriente(self, event):
        ...
        if self.manual:
            #Caso en que la fase A esta seleccionada y se habilita la seleccion de las fallas
            if self.m_checkBox5.IsChecked():
                if self.m_checkBox4.IsChecked() and not self.m_checkBox6.IsChecked():
                    self.faseB=True
                    #self.axes_corriente.set_title('Seleccione el ciclo prefalla')
                    self.dibujar_corriente()
                    self.m_staticText5.SetLabel("Falla en fases A y B")
    ...
    def on_faseC_corriente(self, event):
        ...
        if self.manual:
            #Caso en que la fase A esta seleccionada y se habilita la seleccion de las fallas
            if self.m_checkBox6.IsChecked():
                if self.m_checkBox4.IsChecked() and not self.m_checkBox5.IsChecked():
                    self.faseC=True
                    #self.axes_corriente.set_title('Seleccione el ciclo prefalla')
                    self.dibujar_corriente()
                    self.m_staticText5.SetLabel("Falla en fases A y C")
    ...
    def cargar_datos(self,arreglo):
        ...
        [sirveC, iniPre, iniFalla, Difn]=lect.Verificar(self.objetoComtrade.oscilografia[:,0],self.objetoComtrade.oscilografia[:,9])
        ...
        [sirveB, iniPre, iniFalla, Difn]=lect.Verificar(self.objetoComtrade.oscilografia[:,0],self.objetoComtrade.oscilografia[:,10])
        if (sirveB==1 ):
            self.inicioFalla=iniFalla
            self.finFalla=self.inicioFalla+32
            self.inicioPreFalla=iniPre
        ...
        [sirveA, iniPre, iniFalla, Difn]=lect.Verificar(self.objetoComtrade.oscilografia[:,0],self.objetoComtrade.oscilografia[:,11])
        if (sirveA==1 ):
            self.inicioFalla=iniFalla
            self.finFalla=self.inicioFalla+32
            self.inicioPreFalla=iniPre
        ...
        ##########################################
        #Determina tipo de falla y fases en falla#
        ##########################################
        if sirveA and not sirveB and not sirveC:
            self.Tipo=0
            self.Fase=0
            self.m_textCtrl2.SetValue("A")
            self.m_textCtrl1.SetValue("Monofasica")
        elif not sirveA and sirveB and not sirveC:
            self.Tipo=0
            self.Fase=1
            self.m_textCtrl2.SetValue("B")
            self.m_textCtrl1.SetValue("Monofasica")
        elif not sirveA and not sirveB and sirveC:
            self.Tipo=0
            self.Fase=2
            self.m_textCtrl2.SetValue("C")
            self.m_textCtrl1.SetValue("Monofasica")
        elif sirveA and sirveB and not sirveC:
            self.Tipo=1
            self.Fase=0
            self.m_textCtrl2.SetValue("AB")
            self.m_textCtrl1.SetValue("BIFASICA")
        elif not sirveA and sirveB and sirveC:
            self.Tipo=1
            self.Fase=1
            self.m_textCtrl2.SetValue("BC")
            self.m_textCtrl1.SetValue("BIFASICA")
        elif sirveA and not sirveB and sirveC:
            self.Tipo=1
            self.Fase=2
            self.m_textCtrl2.SetValue("AC")
            self.m_textCtrl1.SetValue("BIFASICA")
        '''else:
            print 'No se pude determinar fases y tipo de falla'
            self.m_textCtrl2.SetValue("No se pude determinar fases y tipo de falla")'''
        ...
        if self.manual:
            ...
            seleccion.ShowModal()
            self.m_listbook1.ChangeSelection(1)
            self.inicioPreFalla=0
            self.sale=False
            self.grafica_dentro_panel()
            ...
            self.dibujar_voltaje()
            self.dibujar_corriente()
            #REVISAR CAMBIAR POR VALOR DE LOCALIZACION DE CLASES_CIRCUITO
    ...
    def EvtComboBoxIndNodo1(self,event):
        #CONSULTA EN CIRCUITO
        #self.m_comboBox7Choices=
        nodo=self.m_comboBox6.GetValue()
        id=self.objetoBaseDatos.consultaId(str(nodo))
        self.m_comboBox7Choices=self.objetoBaseDatos.consultaNodos2Indicadores(id)
    ...
    def EvtTextNuevoIndicador(self,event):
        campo=self.m_textCtrlNuevoIndicador.GetValue()
        if re.match('[a-z]+|[A-Z]+', campo):
            self.m_textCtrlDistanciaIndicador.Enable(True)
        else:
            self.m_textCtrlDistanciaIndicador.Enable(False)
    
    def EvtTextDistanciaIndicador(self,event):
        campo=self.m_textCtrlDistanciaIndicador.GetValue()
        
        if self.validacion_float(campo,self.m_textCtrlDistanciaIndicador): 
            if float(campo)<=0:
                pass
            else:
                self.m_buttonInsertar.Enable(True)
            
            ##REVISAR TERMINAR LA NAVEGABILIDAD, INSERTAR TABLAS, INSERTAR CONSULTAS, CREAR YACOPI CON DATOS SIN IMPORTAR NODOS INTERMEDIOS
        

        
        
    
    def NuevoIndicador(self,event):
        
        
        #se actualizan los dos combo box, eliminar y seleccionar luego de insertado el nodo
        NombreNodo1=self.m_comboBox6.GetValue()
        NombreNodo2=self.m_comboBox7.GetValue()
        Nodo1=int(self.objetoBaseDatos.consultaId(str(NombreNodo1)))
        ...
        if DistanciaIngresada>distancia:
            msg='La distancia ingresada supera la distancia ' +str(distancia)+' Kms del tramo entre los nodos '+str(Nodo1)+' y '+str(Nodo2)
            dlg = wx.MessageDialog(self, msg, "Error", wx.OK|wx.ICON_ERROR)
    ...
    def EliminarIndicador(self,event):
    ...
    def OnGroup2Select( self, event ):
        radio_sel = event.GetEventObject()
        for radio, texto in self.group2_ctrls:
            if radio is radio_sel:
                texto.Enable(True)
                self.m_comboBox7.Enable(False)
                self.m_textCtrlNuevoIndicador.Enable(False)
                ...
                if event.inaxes:
                    if not self.sale and (self.faseA or self.faseB or self.faseC):
                        ...
                        if self.click2:
                            ...
                            if self.faseA and not self.faseB and not self.faseC:
                                self.Tipo=0
                                self.Fase=0
                                self.m_textCtrl2.SetValue("A")
                                self.m_textCtrl1.SetValue("Monofasica")
                            elif not self.faseA and self.faseB and not self.faseC:
                                self.Tipo=0
                                self.Fase=1
                                self.m_textCtrl2.SetValue("B")
                                self.m_textCtrl1.SetValue("Monofasica")
                            elif not self.faseA and not self.faseB and self.faseC:
                                self.Tipo=0
                                self.Fase=2
                                self.m_textCtrl2.SetValue("C")
                                self.m_textCtrl1.SetValue("Monofasica")
                            elif self.faseA and self.faseB and not self.faseC:
                                self.Tipo=1
                                self.Fase=0
                                self.m_textCtrl2.SetValue("AB")
                                self.m_textCtrl1.SetValue("BIFASICA")
                            elif not self.faseA and self.faseB and self.faseC:
                                self.Tipo=1
                                self.Fase=1
                                self.m_textCtrl2.SetValue("BC")
                                self.m_textCtrl1.SetValue("BIFASICA")
                            elif self.faseA and not self.faseB and self.faseC:
                                self.Tipo=1
                                self.Fase=2
                                self.m_textCtrl2.SetValue("AC")
                                self.m_textCtrl1.SetValue("BIFASICA")
                            elif self.faseA and self.faseB and self.faseC:
                                self.Tipo=3
                                self.Fase=0
                                self.m_textCtrl2.SetValue("ABC")
                                self.m_textCtrl1.SetValue("TRIFASICA")
    ...
    def nuevaLocalizacion(self):
        ...
        try:
            ...
            #distancia=40
            #self.Grafo=self.objetoCircuito.punto_falla(retorno,distancia)
            #self.Grafo=self.objetoCircuito.punto_falla(self.Grafo, 1.0,'B1','B2')
            #ARREDAS
        except TypeError:
            msg='''
    ...
    def asignarFalla(self):
        ...
        IcPost= (-1.3352 + 2.6700j)/np.sqrt(2)
        IPost=[IaPost, IbPost, IcPost]'''
        [self.ICpost, Mag, Fase]=lsq.Lsq5(self.objetoComtrade.oscilografia[:,0][self.inicioFalla:self.finFalla], self.objetoComtrade.oscilografia[:,9][self.inicioFalla:self.finFalla]);
        [self.IBpost, Mag, Fase]=lsq.Lsq5(self.objetoComtrade.oscilografia[:,0][self.inicioFalla:self.finFalla], self.objetoComtrade.oscilografia[:,10][self.inicioFalla:self.finFalla]);
        [self.IApost, Mag, Fase]=lsq.Lsq5(self.objetoComtrade.oscilografia[:,0][self.inicioFalla:self.finFalla], self.objetoComtrade.oscilografia[:,11][self.inicioFalla:self.finFalla]);
        
        
        
        self.IApost=self.IApost/np.sqrt(2)
        self.IBpost=self.IBpost/np.sqrt(2)
        self.ICpost=self.ICpost/np.sqrt(2)
        #self.INpost=np.dot(self.u,self.i1n)/np.sqrt(2)'''
        self.IPost=[self.IApost, self.IBpost, self.ICpost]
        ...
        [self.VApost, Mag, Fase]=lsq.Lsq5(self.objetoComtrade.oscilografia[:,0][self.inicioFalla:self.finFalla], self.objetoComtrade.oscilografia[:,5][self.inicioFalla:self.finFalla]);
        [self.VBpost, Mag, Fase]=lsq.Lsq5(self.objetoComtrade.oscilografia[:,0][self.inicioFalla:self.finFalla], self.objetoComtrade.oscilografia[:,4][self.inicioFalla:self.finFalla]);
        [self.VCpost, Mag, Fase]=lsq.Lsq5(self.objetoComtrade.oscilografia[:,0][self.inicioFalla:self.finFalla], self.objetoComtrade.oscilografia[:,3][self.inicioFalla:self.finFalla]);
        
        
        self.VApost=self.VApost/np.sqrt(2)
        self.VBpost=self.VBpost/np.sqrt(2)
        self.VCpost=self.VCpost/np.sqrt(2)
        self.VPost=[self.VApost, self.VBpost, self.VCpost]
    ...
    def takagi(self):
        ...
        casos = { 'A': [self.IApost,self.Ipre[0],self.I0,self.VApost], 'B': [self.IBpost,self.Ipre[1],self.I1,self.VBpost], 'C': [self.ICpost,self.Ipre[2],self.I2,self.VCpost] }
        v=[]
