...
adjb;
% adjb
for i=1:x-1  % La matriz "adjcb" muestra los tramos conectados a cada tramo 
             % (filas), las columnas corresponden a derivaciones. De la
             % segunda columna en adelante se muestran los tramos
...
for s=1:10
    ...
    Ibr; %Corriente de tramo por fase
    xy=length(adjcb(1,:)); % # columnas de la matriz " adjcb "
