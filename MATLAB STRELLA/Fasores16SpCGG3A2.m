...
ZBase = VBase^2/SBase
M = csvread('PruebasTalleres1.csv');
FaseFallada='b';
Ia=M(:,1);
Ib=M(:,2);
Ic=M(:,3);
...
% end
% Z1(1)=(V1(6)-V1(1))/(I1(6)-I1(1));%*ZBase
% Z2(1)=(V2(6)-V2(1))/(I2(6)-I2(1));%*ZBase
% Z0(1)=(V0(6)-V0(1))/(I0(6)-I0(1));%*ZBase
% Z1(2)=(V1(7)-V1(1))/(I1(7)-I1(1));%*ZBase
% Z2(2)=(V2(7)-V2(1))/(I2(7)-I2(1));%*ZBase
% Z0(2)=(V0(7)-V0(1))/(I0(7)-I0(1));%*ZBase
% Z1(3)=(V1(8)-V1(1))/(I1(8)-I1(1));%*ZBase
% Z2(3)=(V2(8)-V2(1))/(I2(8)-I2(1));%*ZBase
% Z0(3)=(V0(8)-V0(1))/(I0(8)-I0(1));%*ZBase
% Z1(4)=(V1(6)-V1(5))/(I1(6)-I1(5));%*ZBase
% Z2(4)=(V2(6)-V2(5))/(I2(6)-I2(5));%*ZBase
% Z0(4)=(V0(6)-V0(5))/(I0(6)-I0(5));%*ZBase
% Z1(5)=(V1(7)-V1(6))/(I1(7)-I1(6));%*ZBase
